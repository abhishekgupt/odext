...
var augmentCallDetailsEntry = function() {
	...
	row += "<tr name="" id=""><td class="fl" style="vertical-align:middle"><span class="requiredText">Product*</span></td><td class="fv" style="padding-left:6px;height:2px;vertical-align:middle"><input name="CallProdDetailNew.Name" size="" tabindex="3" type="text" value="" class="inputControl" id="CallProdDetailNew.Name" /><input type="hidden" id="CallProdDetailNew.Product Id" name="CallProdDetailNew.Product Id" tabindex="-1" value=""><input type="hidden" id="CallProdDetailNew.Name.hidden" name="CallProdDetailNew.Name.hidden" tabindex="-1" value=""><img class="popup" onclick="openAssocPopup('AssocProductPopup?mapBC=Pharma+Call+Products+Detailed&#38;OACTRL=Name&#38;ophi=CallProdDetailNew.Product+Id&#38;pfid=CallProdDetailNew&#38;OMTHD=AssocPopup&#38;OMTGT=PopupSearchList&#38;assocInit=Y&#38;opht=4&#38;OAOBJ=Call+ProdDetail&#38;mapField=Name&#38;ophd=CallProdDetailNew.Name&#38;ophpd=1&#38;disableclear=Y&#38;ophr=AssocProductPopup',350,500,'OccamPopup1','CallProdDetailNew.Product Id',true,false);" src="../1.10.0.10                79.0.03/base/themes/oracle/images/iconSearch.gif" /></td></tr>";
