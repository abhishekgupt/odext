...
var augmentCallDetailsEntry = function() {
	...
	row += "<td><p style='color:red'>Indication*:<select name=CallProdDetailNew.Indication tabindex='5' size='10' onchange=onDropDownChange (this); class=inputControl id=CallProdDetailNew.Indication><option /><option value='Allergy'>Allergy</option><option value='Asthma'>Asthma</option><option value='Arrhythmia'>Arrhythmia</option><option value='Heart Failure'>Heart Failure</option><option value='Syncope'>Syncope</option><option value='Other'>Other</option></td>";
	row += "<td>Issues:<select name=CallProdDetailNew.Issue tabindex='6' size='10' onchange=onDropDownChange (this); class=inputControl id=CallProdDetailNew.Issue><option /><option value='Side Effects'>Side Effects</option><option value='Efficacy'>Efficacy</option><option value='Cost vs. Generics'>Cost vs. Generics</option><option value='Price'>Price</option></td>";
