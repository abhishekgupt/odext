...
var augmentCallDetailsEntry = function() {
	...
	row += "<td><td class='fl' style='vertical-align:middle'><span class='requiredText' style='color:red'>Product* </span></td><td class='fv' style='padding-left:6px;height:2px;vertical-align:middle'><select width='130' STYLE='width: 130px' size='0'><option></option><option>Singulair </option><option>Hyzaar</option></td>";
	row += "<td><td class='fl' style='vertical-align:middle'><span class='fl'>Priority </span></td><td class='fv' width='130' STYLE='width: 130px'><input name='CallProdDetailNew.Priority' size='20' tabindex='4' type='text' value='' class=inputControl id=CallProdDetailNew.Priority/></td>";
