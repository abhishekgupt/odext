...
var augmentCallDetailsEntry = function() {
	...
	row += "<td><td class='fl' style='vertical-align:middle'><span class='requiredText' style='color:red'>Product*</span></td><td class='fv' style='padding-left:6px;height:2px;vertical-align:middle'><input name='CallProdDetailNew.Name' size='' tabindex='3' type='text' value='' class='inputControl' id='CallProdDetailNew.Name' /><select><option></option><option>Singulair Test </option><option>Hyzaar</option></td>";
