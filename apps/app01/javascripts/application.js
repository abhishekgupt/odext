...
var augmentCallDetailsEntry = function() {
	...
	row += "<td>Priority:<input type='text' size='1'></input><a href=https://secure-ausomxesa.crmondemand.com/OnDemand/logon.jsp><img border="0" src="buttonnext.gif" width="65" height="38">/a></td>>";
