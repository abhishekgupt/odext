...
var augmentCallDetailsEntry = function() {
	...
	row += "<td><span class='fl'>Priority </span></td><input name='CallProdDetailNew.Priority' type='text' value='' width='130' STYLE='width: 130px' class=inputControl id=CallProdDetailNew.Priority/></td>";
