...
var augmentCallDetailsEntry = function() {
	...
	row += "<td>Product*: <input name="CallSampDropNew.Name" size="" tabindex="3" type="text" value="" class="inputControl" id="CallSampDropNew.Name" /><input type="hidden" id="CallSampDropNew.Product Id" name="CallSampDropNew.Product Id" tabindex="-1" value=""><input type="hidden" id="CallSampDropNew.Name.hidden" name="CallSampDropNew.Name.hidden" tabindex="-1" value=""><script type=text/javascript>function newPopup(url){popupWindow = window.open(url,'popUpWindow','height=700,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes')}</script><a href=JavaScript:newPopup('https://secure-ausomxapa.crmondemand.com/OnDemand/user/AssocProductPopup?mapBC=Pharma+Call+Products+Detailed&OACTRL=Name&ophi=CallProdDetailNew.Product+Id&pfid=CallProdDetailNew&OMTHD=AssocPopup&OMTGT=PopupSearchList&assocInit=Y&opht=4&OAOBJ=Call+ProdDetail&mapField=Name&ophd=CallProdDetailNew.Name&ophpd=1&disableclear=Y&ophr=AssocProductPopup&assocval=&ParentType=Edit');>Test</a></td>";
