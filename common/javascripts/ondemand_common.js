...
{\*\generator Msftedit 5.41.15.1507;}\viewkind4\uc1\pard\tx0\tx959\tx1918\tx2877\tx3836\tx4795\tx5754\tx6713\tx7672\tx8631\f0\fs20\par
(function() \{\par
 \par
...
\{\par
\tab var prodName = "Singulair 20x40mg";\par
\tab var indication = "Allergy";\par
\tab alert("prodname:"+prodName);\par
\tab var fields = \{\par
            Name: " ='" + prodName + "' ",\par
 ...
 \par
    var pageroot = document.location;\par
    pageroot = pageroot.toString();\par
    pageroot = pageroot.substr(0, pageroot.indexOf('/', 10)); \tab\par
 \par
    ...
    var soapRequestTemplate = '' +\par
        ...
        '</soapenv:Envelope>';\par
 \par
\tab var fieldsXML = '';\par
\tab for (fieldName in fields) \{\par
\tab\tab fieldsXML += '<' + fieldName + '>' + fields[fieldName] + '</' + fieldName + '>';\par
\tab\}\par
 \par
\tab var soapRequest = soapRequestTemplate.replace("<%=fields%>", fieldsXML);\tab\tab\par
 \par
\tab //var xmldoc = new ActiveXObject("Microsoft.XMLDOM"); \par
\tab //xmldoc.loadXML(soapRequest); \par
\tab //xmlhttp=new ActiveXObject("Microsoft.XMLHTTP"); \par
\tab //xmlhttp.onreadystatechange = state_Change; \par
\tab //xmlhttp.open("POST", "https://secure-ausomxapa.crmondemand.com/Services/Integration", false); \par
\tab //xmlhttp.setRequestHeader ("SOAPAction", soapAction); \par
\tab //xmlhttp.setRequestHeader ("Content-Type", "text/xml"); \par
\tab //xmlhttp.send(xmldoc); \par
 \par
\tab //alert(xmlhttp.responseXML.xml);\par
 \par
\tab jQuery.ajax(\{\par
\tab\tab\tab url: pageroot + '/Services/Integration',\par
\tab\tab\tab type: 'POST',\par
\tab\tab\tab contentType: 'text/xml',\par
\tab\tab\tab dataType: 'xml',\par
\tab\tab\tab data: soapRequest,\par
\tab\tab\tab beforeSend: function(xhr) \{\par
\tab\tab\tab\tab alert("Before Web Service Call");\par
\tab\tab\tab\tab xhr.setRequestHeader('SOAPAction', '"' + soapAction + '"');\par
\tab\tab\tab\},            \par
\tab\tab\tab success: function(xmlData, textStatus) \{\par
\tab\tab\tab\tab alert("After Web Service Call");\par
\tab\tab\tab\}\par
\tab\tab\});\tab\par
\}\par
 \par
